...
public class EventDemo {
	...
	public static void main(String[] args) {
		...
		Event three = new Event(setEventNumber(), setGuests());
		System.out.println("Your Event Number: " + three.getEventNumber());
		largerEvent(one, two);
		largerEvent(two, three);
		largerEvent(one, three);
	}
	...
	public static void largerEvent(Event x, Event y) {
		if(x.getGuests() > y.getGuests())
			System.out.println("Event " + x.getEventNumber() + " is larger.");
		else
			if(y.getGuests() > x.getGuests())
				System.out.println("Event " + y.getEventNumber() + " is larger.");
			else
